function Header()
{
	...
	<div className="container flex justify-between h-12 mx-auto">
		...
		<h1 className="my-1 text-3xl font-bold text-cyan-600">Welcome, Sirugudi</h1>
		</div>
		...
		<div className="flex items-center md:space-x-4">
			...
			<button type="button" className="hidden px-6 py-2 font-semibold rounded lg:block bg-cyan-600 text-gray-50">Log out</button>
		</div>
